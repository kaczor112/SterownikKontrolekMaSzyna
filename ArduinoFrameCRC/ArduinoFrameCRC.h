...
#ifndef ArduinoFrameCRC_h
#define ArduinoFrameCRC_h
const uint16_t crcTable[] PROGMEM = {
  ...
  // Statyczna tablica CRC

class CRC16
{
private:
    uint16_t _crcValue = 0xFFFF;                   // Aktualna wartość CRC
...
class ArduinoFrameCRC
{
private:
    CRC16 _arduinoCRC;

public:
    uint8_t fullFrame[256] = {0};
    uint8_t lengthFrame = 0;
    ...
    void TakeWithSerial(HardwareSerial &mySerial);
